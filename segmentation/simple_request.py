...
def predict_result(image_path):
    ...
    dataload = {'smooth': 0.75, 'lip_brighten': 0.3, 'whiten': 0.2, 'sharpen': 0.35, 'thin': 0.8}

    # Submit the request.
    picture_bytes = requests.post(PyTorch_REST_API_URL, data=json.dumps(dataload), files=payload)
